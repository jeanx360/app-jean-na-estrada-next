...
import { ArrowLeft, Clock3, Gauge, ReceiptText, TrendingDown, TrendingUp, WalletCards } from "lucide-react";
    ...
    <div className="page-stack driver-page">
      ...
      <div className="driver-finance-detail-grid">
        ...
        <aside className="driver-finance-side-column">
          <DriverTripActions tripId={trip.id} initialStatus={trip.status} />
