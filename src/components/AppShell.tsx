  ...
  return (
    <div className="app-shell">
      ...
      <aside className={`sidebar ${menuOpen ? "is-open" : ""}`}>
        ...
        <div className="sidebar__card"><span className="sidebar__card-badge">JNE APP</span><strong>Uma plataforma feita para crescer.</strong><p>Conteúdo, ferramentas, comunidade e recursos profissionais em um só lugar.</p></div>
        <p className="sidebar__version" suppressHydrationWarning>Versão 1.6.1</p>
      </aside>
