...
import { ArrowLeft, ArrowRight, Check, Eye, LoaderCircle, Save, ShieldCheck } from "lucide-react";
  ...
  return (
    <div className="driver-profile-builder">
      <section className="driver-profile-builder__form">
        ...
        {step === 1 ? (
          <div className="driver-builder-step">
            <div className="driver-builder-step__heading"><span className="eyebrow">PASSO 2 DE 3</span><h2>Seu atendimento</h2><p>Mostre só o que ajuda o passageiro a decidir.</p></div>
            <div className="driver-field-grid">
